-- Base de datos unificada del CMS.
-- Conserva todos los registros funcionales de ambos dumps y excluye las tablas internas de phpMyAdmin.
-- Importar en una base nueva llamada basededatos; este archivo no contiene DROP TABLE.
...
--
-- Servidor: 127.0.0.1
-- Tiempo de generaciÃ³n: 01-05-2026 a las 00:42:32
...
(20, 11, 'Integrantesa de the cure', '\r\n<h2>Integrantes de The Cure</h2>\r\n\r\n<p><strong>The Cure</strong> es una banda britÃ¡nica de rock alternativo formada en 1976. A lo largo de los aÃ±os, tuvo varios cambios en su formaciÃ³n, pero su lÃ­der y figura principal siempre fue <strong>Robert Smith</strong>, cantante, guitarrista y compositor.</p>\r\n\r\n<p>Entre los integrantes mÃ¡s destacados se encuentran <strong>Simon Gallup</strong> en el bajo, conocido por su estilo sÃ³lido y caracterÃ­stico; <strong>Porl (Pearl) Thompson</strong> en guitarra, quien aportÃ³ gran parte del sonido atmosfÃ©rico de la banda; y <strong>Lol Tolhurst</strong>, miembro fundador que participÃ³ en teclados y baterÃ­a en los primeros aÃ±os.</p>\r\n\r\n<p>Con el tiempo, otros mÃºsicos se sumaron, como <strong>Jason Cooper</strong> en baterÃ­a y <strong>Roger ODonnell</strong> en teclados, consolidando el sonido Ãºnico que hizo famosa a la banda.</p>\r\n\r\n<p>The Cure es reconocida por su influencia en el rock gÃ³tico y alternativo, y por mantener una identidad musical distintiva durante dÃ©cadas.</p>\r\n```\r\n', 'cure-1995.jpg', '', 1, 1, 'integrantes'),
(21, 11, 'la historia de la banda', '           <h2>Historia de The Cure</h2>\r\n\r\n<p><strong>The Cure</strong> se formo en 1976 en Inglaterra, cuando un grupo de jovenes decidio crear musica con un estilo propio. Al principio, la banda tenia un sonido mas cercano al punk, pero con el tiempo fue evolucionando hacia un estilo mas oscuro y melodico.</p>\r\n\r\n<p>Su primer album, <strong>Three Imaginary Boys</strong>, fue lanzado en 1979 y marco el inicio de su carrera. Con el paso de los aÃ±os, la banda gano popularidad con discos como <strong>Seventeen Seconds</strong>, <strong>Faith</strong> y <strong>Pornography</strong>, que definieron su etapa mas oscura.</p>\r\n\r\n<p>En la decada de 1980, lograron un gran exito comercial con canciones mas accesibles como <strong>Just Like Heaven</strong> y <strong>Friday Im in Love</strong>, ampliando su publico a nivel mundial.</p>\r\n\r\n<p>A pesar de los cambios en su formacion, la banda continuo activa durante las siguientes decadas, manteniendo su estilo unico y consolidandose como una de las mas influyentes del rock alternativo.</p>', 'The-Cure-Credit-Vinnie-Zuffante-Michael-Ochs-Archives-Getty-Images@2000x1500.jpg', '', 1, 2, 'history'),
...
(7, 2, 'Guitarra Electrica segun la IA', '  Una guitarra elÃ©ctrica es un instrumento de cuerda con cuerpo sÃ³lido o semi-sÃ³lido (sin caja de resonancia acÃºstica) que utiliza pastillas electromagnÃ©ticas para convertir la vibraciÃ³n de sus cuerdas de metal en seÃ±ales elÃ©ctricas. Estas seÃ±ales se envÃ­an a un amplificador externo para producir sonido. ', '', '', 1, 1);
...
-- Registros de encuestas conservados desde base.sql
INSERT INTO `encuestas` (`id_encuesta`, `pregunta`, `descripcion`, `id_tecnologia`, `activo`, `creado_en`) VALUES
(1, 'Â¿CuÃ¡l es tu banda favorita?', 'Encuesta general de preferencias musicales', 11, 1, NOW());
